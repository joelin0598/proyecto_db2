...
GRANT SELECT, INSERT, UPDATE, DELETE ON C##STAGE.BD2_STG_DATOS_TEMP TO C##DW;
GRANT SELECT, INSERT, UPDATE, DELETE ON C##STAGE.BD2_STG_DATOS_TEMP TO C##PRODUCCION;
CREATE SYNONYM BD2_STG_DATOS_TEMP FOR C##STAGE.BD2_STG_DATOS_TEMP;
...
END;
--------------------------------
CREATE TABLE C##STAGE.BD2_STG_DATOS_TEMP (
  ANIO            NUMBER,
  FECHA           DATE,
  HORA            VARCHAR2(5),
  RONDA           VARCHAR2(50),
...
BEGIN
  ...
  SELECT
    ANIO, FECHA, HORA, RONDA, ESTADIO, CIUDAD, PAIS,
    EQUIPO_LOCAL, GOL_LOCAL, EQUIPO_VISITA, GOL_VISITA, ASISTENCIA
  FROM C##STAGE.BD2_STG_DATOS_TEMP;
